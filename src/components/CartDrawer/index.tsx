...
export const CartDrawer = ({ isOpen, onClose}: CartDrawerProps) => {
  ...
  return (
    ...
    >
      <div
        className={`${isOpen ? "translate-x-0" : "translate-x-full"} h-full absolute right-0 top-0 bottom-0 pt-6 bg-background transition-all ease-in-out duration-600 w-75 md:w-106 z-50`}
